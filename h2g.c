...
static long
SSearchfile(const char *pattern)
{
  long snumb[99];
...
static int
convert_sid(const char *inpath, const char *outpath)
{
  FILE *f;
  long fslen, i, i2;
  unsigned char b1, b2;
